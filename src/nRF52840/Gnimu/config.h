...
// Board-frame axes, to be bench-confirmed via src/tools/imu_tiltmap
...
// API for this) per ST AN4650. Bench-tuned via src/tools/imu_wake.
...
// the FS_XL chosen above; re-tune with src/tools/imu_wake if FS_XL changes.
...
// covers up to ~800k. Bench-validated via src/tools/battery_presence. Value
