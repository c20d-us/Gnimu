...
ESP32_DIR="$REPO_ROOT/src/Gnimu-ESP32"
NRF_DIR="$REPO_ROOT/src/Gnimu-nRF52840"
...
if [ "$status" -eq 0 ]; then
  ...
  echo "review the differences (e.g. diff src/Gnimu-ESP32/<file> src/Gnimu-nRF52840/<file>),"
